...
public class ProductController {
	...
	public String processGetProductForm(@RequestParam("productId") int id,
			Model model) {
		try {
	...
	public String processFetchForUpdateForm(@RequestParam("productId") int id,
			Model model) {
		try {
			Product product = productService.getProduct(id);
	...
	public String processRemoveProductForm(@RequestParam("productId") int id,
			Model model) {
		try {
			Product product = productService.getProduct(id);
